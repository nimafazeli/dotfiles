...
you should place your code here."
  ...
  ;; pdf tools as default inside emacs
  ...
  (with-eval-after-load 'org
    ...
    (setq org-capture-templates '(
                                  ("b" "Blog idea" entry (file+headline "~/Dropbox/org/notes.org" "Blog ideas:") "* %?\n%T" :prepend t)
                                  ("t" "Task" entry (file+headline "~/Dropbox/org/inbox.org" "Tasks") "* TODO  %?" :prepend t)
                                  ("a" "Appointment" entry (file+headline  "~/Dropbox/org/schedule.org" "Appointments") "* %^{Description} %^g %?\n")
                                  ("e" "Event" entry (file+headline  "~/Dropbox/org/schedule.org" "Events") "* %^{Description} %^g %?\n SCHEDULED: %T %i %a")
                                  ("n" "Note" entry (file+headline "~/Dropbox/org/notes.org" "Notes") "* %? " :prepend t)
                                  ("l" "Note+link" entry (file+headline "~/Dropbox/org/notes.org" "Notes") "* %? \n%a" :prepend t)
                                  ("j" "Journal" entry (file+olp+datetree "~/Dropbox/org/journal.org") "* ---Entered on %U\n %?" :time-prompt t)
                                  ))
    ;; targets to refile from inbox
    (setq org-refile-targets
          '(("~/Dropbox/org/tasks.org" :maxlevel . 3)
            ("~/Dropbox/org/notes.org" :maxlevel . 3)
            ("~/Dropbox/org/inbox.org.org" :maxlevel . 4)
            ("~/Dropbox/org/schedule.org" :maxlevel . 3 )))
    (setq org-archive-subtree-add-inherited-tags t)
    ;; task keywords
    (setq org-todo-keywords '(
                              (sequence "PROJECT(p)" "TODO(t)" "INPROGRESS(i)" "|" "DONE(d)" "CANCELLED(c)")))

    (setq org-todo-keyword-faces
          '(("PROJECT" . (:foreground "red" :weight bold :underline t))
            )
          )
  ...
  ;; zetteldeft
  (setq deft-directory "~/Dropbox/jotter")
  (setq deft-extensions '("org" "md"))
  (setq zetteldeft-title-suffix "\n#+AUTHOR: Nima Fazeli\n#+BIBLIOGRAPHY: c:/Users/nima/Dropbox/mylibrary/references.bib\n
")
...
")
  (setq org-ref-default-bibliography '("~/Dropbox/mylibrary/references.bib")
        org-ref-pdf-directory "~/Dropbox/mylibrary/papers/"
        org-ref-bibliography-notes "~/Dropbox/mylibrary/literature.org")

  (setq bibtex-completion-library-path '("~/Dropbox/mylibrary/papers"))
  (setq bibtex-completion-bibliography '("~/Dropbox/mylibrary/references.bib"))
  ...
  (add-hook 'elfeed-show-mode-hook
            (lambda ()
              ...
              (set-face-attribute 'variable-pitch (selected-frame) :font "georgia-10")
  ...
  (define-key evil-normal-state-map (kbd "L") (lambda () (interactive) (evil-forward-WORD-end)))
  (define-key evil-normal-state-map (kbd "H") (lambda () (interactive) (evil-backward-WORD-begin)))
  ;; (define-key evil-insert-state-map (kbd "C-j") 'evil-join)

  ;; Ctrl-shift up and down move lines (like in sublime)
...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/GDrive/Teaching/IntEcon/IntEcon.org" "~/OneDrive/projects/HealthData/README.org" "~/Dropbox/org/notes.org" "~/Dropbox/org/schedule.org" "~/Dropbox/org/inbox.org")))
 '(package-selected-packages
   (quote
    (yaml-mode web-beautify utop caml typescript-mode seeing-is-believing rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocopfmt rubocop rspec-mode rbenv rake prettier-js ocp-indent ob-elixir nodejs-repl mvn minitest merlin-eldoc meghanada maven-test-mode lsp-java cfrs livid-mode skewer-mode simple-httpd json-navigator hierarchy json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc groovy-mode groovy-imports git-gutter-fringe+ fringe-helper git-gutter+ flycheck-ocaml merlin flycheck-credo emojify emoji-cheat-sheet-plus dune haskell-mode company-emoji chruby inf-ruby browse-at-remote alchemist elixir-mode ranger pandoc-mode ox-pandoc ht helm-company helm-c-yasnippet fuzzy company-statistics company auto-yasnippet yasnippet ac-ispell auto-complete mmm-mode markdown-toc markdown-mode gh-md zenburn-theme zen-and-art-theme xterm-color white-sand-theme underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme toxi-theme tao-theme tangotango-theme tango-plus-theme tango-2-theme sunny-day-theme sublime-themes subatomic256-theme subatomic-theme spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme shell-pop seti-theme reverse-theme rebecca-theme railscasts-theme purple-haze-theme professional-theme planet-theme phoenix-dark-pink-theme phoenix-dark-mono-theme organic-green-theme omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme naquadah-theme mustang-theme multi-term monokai-theme monochrome-theme molokai-theme moe-theme minimal-theme material-theme majapahit-theme madhat2r-theme lush-theme light-soap-theme jbeans-theme jazz-theme ir-black-theme inkpot-theme heroku-theme hemisu-theme hc-zenburn-theme gruvbox-theme gruber-darker-theme grandshell-theme gotham-theme gandalf-theme flatui-theme flatland-theme farmhouse-theme exotica-theme espresso-theme eshell-z eshell-prompt-extras esh-help dracula-theme django-theme darktooth-theme autothemer darkokai-theme darkmine-theme darkburn-theme dakrone-theme cyberpunk-theme color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized clues-theme cherry-blossom-theme busybee-theme bubbleberry-theme birds-of-paradise-plus-theme badwolf-theme apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes afternoon-theme fsharp-mode eglot xref flymake jsonrpc eldoc project ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-make helm-flx helm-descbinds helm-ag google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired f evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async)))
